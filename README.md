...
## Inteface
1.1 Input do usuario para criação do envelope: Mensagem, o nome do arquivo de saida da mensagem, sua chave privada privada usada para assinatura e a chave publica do destinatario(o string path do arquivo delas)
